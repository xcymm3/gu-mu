...
export const scenes: Record<string, Scene> = {
  gate: {
    ...
    choices: [
      { id: "jade", label: "旧玉烫得厉害，你不动声色地把它攥进掌心，只当没察觉", next: "swarm", result: "旧玉在掌心下愈发烫人，仿佛门后有一双眼睛，正透过这枚玉与你遥遥对视。你不动声色地将它攥得更紧，只当什么都没察觉，却已暗中记下了这份异样。玉烫得越急，你便越笃定——这座墓里，藏着与你血脉相连的东西。", effect: { flag: "旧玉发烫" } },
