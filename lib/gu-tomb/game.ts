...
export const scenes: Record<string, Scene> = {
  ...
  swarm: {
    ...
    text: "入墓不过百步，石壁缝隙便涌出万千噬魂蛊，黑压压一片，先是细密的沙沙声贴着砖缝游来，旋即如潮水漫过整条甬道，腥气呛得人眼眶发酸。乔无咎举着火折子照了照，声音不紧不慢：“噬魂蛊闻血而动。诸位若不想当饵，就别把血洒出来。”话说完，他反倒退到队尾，负手站定，像在欣赏一出与己无关的好戏。\n\n赵黎袖中血纹蛊虫振翅，近身蛊虫无声自焚，尽数化作飞灰，仿佛被更暴烈的蛊力从内里撕碎；你与纪清寒被黑潮挤向侧壁，一条毒藤无声缠上你的脚踝，她引剑蛊一掠，藤断，你的裤脚只裂开一线——同一瞬，蛊蝎扑向她后颈，你反手催动月光蛊，一线月白将那蝎子钉死在砖缝里。薛逢在队尾被撵得抱头鼠窜，嘴里翻来覆去只剩“退路、退路”。\n\n混乱里，乔无咎始终站在火折子照得最亮的那一处。火光把他的半张脸照得忽明忽暗，谁也看不清他是在笑，还是在看。",
    choices: [
      { id: "shout-xue", label: "回身朝薛逢喝道：“别退，贴壁走！”", next: "shadow", result: "你回身一声断喝：“别退，贴壁走！”薛逢愣了一下，随即连滚带爬地贴住石壁，蛊潮竟真的从他身侧涌了过去，绕开了他。他惊魂未定，朝你挤出一个比哭还难看的笑。赵黎在几步外皱了皱眉，似嫌你多事，扰了他观蛊的兴致——他掌心的血纹蛊虫，分明已替你们清出一条路来。", effect: { trust: { xue: 1, zhao: -1 } } },
      { id: "shift-ji", label: "与纪清寒错身换位，替她守住后颈方向", next: "shadow", result: "你与纪清寒错身换位，把自己堵在她身后，替她守住了后颈的死角。她什么都没说，只在你错身时看了你一眼——那一眼极短，却像是把后背交出去的默许。蛊潮从你身侧涌过，她出剑再无后顾之忧。薛逢被挤到队尾，在蛊潮里左支右绌，看向你们这边的眼神，多了几分说不清道不明的东西。", effect: { trust: { ji: 1, xue: -1 } } },
      { id: "observe-all", label: "按住旧玉，任蛊潮从身侧绕开，静静观察众人", next: "shadow", result: "你按住旧玉，站在原地一动不动。奇的是，蛊潮涌到你身前三尺，竟像撞上一堵无形的墙，自动绕开你的脚下。你借着这片刻安稳把众人尽收眼底：赵黎杀蛊干脆利落，一眼都不多看旁人；薛逢忙着逃命，嘴上却还不忘报每个人的方位。只有苏莹，在你目光落过去的刹那垂下头去，像被什么刺了一下——你掌心那枚旧玉，也在那一瞬，烫得更厉害了。", effect: { trust: { zhao: 1, su: -1 } } },
    ],
  },
  shadow: {
    id: "shadow", act: 2, node: 2, chapter: "第二幕 · 入 · 节点 2 / 6", title: "血影示警",
    text: "蛊潮退去后，甬道静得能听见自己的心跳。石壁深处，却有一道血影随着火折子的光缓缓移动——它没有轮廓，像一团被水洇开的朱砂，贴着石面游走。你腰间旧玉骤然发烫，灼得皮肤生疼，比入墓前更烈了几分。\n\n赵黎停下脚步，隔着众人望来，声音不高，却清清楚楚：“那块玉，借老夫瞧瞧？”\n\n你没有应声。他也不逼，只笑笑道：“一会儿你若死了，玉归老夫，提前说好。”纪清寒恰好与你并肩，压着声线道：“这墓的机关有生门，不像防人进，倒像在等什么人。”她说到“等什么人”时，那血影恰好停在石壁上一处暗纹前，像在侧耳倾听。",
    choices: [
      { id: "refuse-zhao", label: "对赵黎摇了摇头，把旧玉收回袖中", next: "chamber", result: "你对赵黎摇了摇头，把旧玉收回袖中。他挑了下眉，笑意淡了几分，却也没再纠缠，只意味深长地看你一眼——那一眼的意思很明白：记下了。反倒是一旁始终沉默的纪清寒，在你收玉时多看了你一眼，眼中似有赞许。你不肯交玉，她不问缘由；她懂这种把来历捂得死死的人。血影仍在石壁上缓缓游动，像在等着看这出戏如何收场。", effect: { trust: { zhao: -1, ji: 1 } } },
      { id: "ask-ji", label: "侧耳听完纪清寒的低语，轻声追问：“等谁？”", next: "chamber", result: "你侧耳听完纪清寒的低语，轻声追问：“等谁？”她顿了很久，久到你以为她不会答，才极轻地补了一句没头没尾的话。那句话像一粒冰落进心里，却慢慢化开成一扇门的轮廓。你把它记下，没有声张。苏莹在不远处听见你们的对话，肩膀几不可察地一颤，像被戳中了什么心事。这一路，你头一回觉得，这座墓里的门，或许不都是用来防人的。", effect: { trust: { ji: 1, su: 1 }, flag: "生门低语" } },
      { id: "ask-su", label: "转向苏莹，问她墓主究竟在等什么人", next: "chamber", result: "你转向苏莹，问她墓主究竟在等什么人。她脸色一白，指尖在石壁暗纹上顿住，半晌才说出几个字——声音很轻，像在说给自己听。你从她的神色里读懂了一层别的意思：她知道答案，只是不能说，也不敢说。赵黎在旁听得饶有兴致，看你的眼神里多了几分“你倒是敢问”的意味；纪清寒却皱了皱眉，似嫌你把不该捅破的窗户纸捅破了。", effect: { trust: { su: 1, zhao: 1, ji: -1 }, flag: "活符低语" } },
    ],
  },
  chamber: {
    id: "chamber", act: 2, node: 3, chapter: "第二幕 · 入 · 节点 3 / 6", title: "机关暗室",
    text: "脚下石板毫无征兆地塌陷，众人跌入一间刻满血色蛊纹的暗室。正中石鼎里积着干涸的血垢，一层叠一层，像经年累月的香灰。苏莹盯着墙上符文，面色一点点发白：“这些符……是活的，血还在动。”\n\n墙角石龛里封着五只蛊卵，冰玉裹身，各色蛊息吞吐明灭。是你先发现的——卵壳下的光，像五双闭着的眼睛。乔无咎扫了一眼，淡淡道：“见者有份，谁找到的，谁先挑。”五只蛊里，唯有一只甲纹森森、一只血芒吞吐，其余三只任你如何感应都毫无回应——仿佛生来就与你无缘，也像在等着别的什么人。",
    choices: [
      { id: "take-armor", label: "取那枚甲纹森森的蛊卵，收入蛊囊", next: "illusion", result: "你伸手取那枚甲纹森森的蛊卵。入手冰凉，纹路如甲片般细密，贴在掌心时竟像活物般微微蜷起。你将它收进蛊囊，腰间原本的甲衣蛊似有所感，蛊囊里传来一阵细碎的震颤——像旧臣迎回新主，又像在提醒你，从今往后护身的法子，要换一种了。卵壳里的光，在你合上蛊囊的刹那，悄然暗了下去。", effect: { flag: "血甲蛊" } },
      { id: "take-blade", label: "取那枚血芒吞吐的蛊卵，收入蛊囊", next: "illusion", result: "你取那枚血芒吞吐的蛊卵。入手微温，不像死物，内里竟似有一缕温热的心跳，一下一下，撞在你的指腹上。你将它收进蛊囊，原本温驯的月光蛊光晕猛地黯淡了一瞬，像被压了一头。新蛊在囊中安静下来，你却能感觉到，它正缓缓地、缓缓地，把自己盘成一线锋刃的形状。", effect: { flag: "血刃蛊" } },
      { id: "yield-su", label: "让出先手，示意苏莹先挑她认得的", next: "illusion", result: "你让出先手，示意苏莹先挑。她怔了怔，似没料到你会让，轻声道了句谢，随即俯身，指尖在五只蛊卵上逐一拂过——那动作不像挑拣，更像在与什么旧识相认。她最后停在那枚血芒最淡的蛊卵前，看了很久，却没有取走，只垂下眼道：“它们……都在等人。”你从她的话里，听出一点与这座墓有关的旧事。", effect: { trust: { su: 1 }, flag: "活符低语" } },
    ],
  },
  illusion: {
    id: "illusion", act: 2, node: 4, chapter: "第二幕 · 入 · 节点 4 / 6", title: "迷魂阵",
    text: "石殿弥漫着甜腥的蛊香，起初只是若有若无，等你察觉时，已重得化不开。你只觉眼前一花，甬道、火光、同行之人尽数消失——你回到了记忆里的那片旧宅，檐下站着那个总唤你小名的青梅竹马。她朝你笑，你朝她走，越走越近，近得能看清她眼角一颗小痣。\n\n然后，幻境碎了。\n\n你回过神来，眼前不是旧宅，是石殿；你手里牵着的不是青梅竹马，是纪清寒的手。那只手冰得没有一丝温度，僵在你掌心里。她同样僵着，耳根却烧得通红。是乔无咎破的阵——他不知何时退到阵眼，一枚暗红蛊印按在石壁，幻象应声而碎。他先朝你与纪清寒这边抬了抬下巴：“两位，回神了。”\n\n趁他转身去破其余几处阵眼，你才看清旁人被幻境困住的模样：赵黎僵立原地，掌中血纹蛊虫乱了轨迹，像在替主人压住什么；薛逢对着空处伸手抓了又抓，抓的全是抓不到的蛊晶；苏莹对着石壁喃喃念咒，念的是半句没人教全的旧咒，眼角有泪。",
    choices: [
      { id: "hold-ji", label: "抬手按住纪清寒的剑柄，对薛逢摇了摇头", next: "puppets", result: "幻境碎后，纪清寒的手还僵在你掌心里，另一只手却已按上剑柄，剑身无声地推出半寸——她分不清眼前是人是幻。你抬手按住她的剑柄，对她摇了摇头，又原样朝薛逢做了一遍。她僵了僵，指尖一根根松开剑鞘，没有问为什么；薛逢讪讪退后半步，脸上的笑凝了一瞬，又堆厚了几分。经此一按，纪清寒看你的眼神，不再像看一个陌路人。", effect: { trust: { ji: 1, xue: -1 } } },
      { id: "ask-su", label: "若无其事地岔开话，问苏莹有无被阵法伤到", next: "puppets", result: "幻境的余韵还压在每个人心头，你却若无其事地岔开话，问苏莹方才可有被阵法伤到。她像从噩梦里被叫醒，怔怔抬眼看你，半晌才摇了摇头，声音哑哑地道了声谢。你这一问，算是替她解了围——她方才对着石壁念旧咒的模样，落在谁眼里都太扎眼。纪清寒却偏过头去，握剑的手紧了一紧，眼神冷了下来。", effect: { trust: { su: 1, ji: -1 } } },
      { id: "fix-ji", label: "沉默着替纪清寒把歪斜的剑穗扶正", next: "puppets", result: "你什么也没说，只是抬手，替纪清寒把打斗时歪斜的剑穗轻轻扶正。剑穗是旧绢缠的，染过血，又在幻境里被攥得发皱。她没看你，耳根却一点点红了起来，攥剑的手松开又握紧，最后只低低说了句“走吧”。苏莹在不远处看着，眼里浮起一点笑意，像终于见到这墓里还有活人的温度；赵黎却在暗处冷哼了一声。", effect: { trust: { ji: 1, su: 1, zhao: -1 } } },
      { id: "follow-qiao", label: "破阵后，你见乔无咎独自拐进一条暗得反常的岔道，脚步极轻，像在避人。你跟了上去。", next: "shadowQiao", result: "你屏息跟上乔无咎，隐进暗影。他的脚步极轻，落脚时几乎不沾尘土，像早在这座墓里走过千百遍。岔道越走越窄，火折子的光被他压得只剩豆大一点——他在避人，也在认路。你跟了三道弯，心头那点疑虑越来越重：一个引众人入墓的散修，凭什么对这墓里的暗路熟成这般？", requires: { flags: ["识破棋局"] } },
    ],
  },
  puppets: {
    id: "puppets", act: 2, node: 5, chapter: "第二幕 · 入 · 节点 5 / 6", title: "铜皮傀儡",
    text: (state) => {
      const base = "墓道骤然开阔，尽头是一处地下石坪，四壁凿痕粗粝，像被蛮力硬生生掏出来的。四角铜皮傀儡同时睁开猩红蛊核，活蛊线牵动关节，一步一响，力道不输炼体蛊修。赵黎随手捏碎一具，皱起眉：“活蛊线只能由近处施术者维持。”\n\n这句话说得轻，落在你耳里却不轻。乔无咎站在石坪上，面色如常，只说是墓主留下的守墓机关。你数了数石坪五条出口，却发现他恰好挡在最像生门的那一侧——不偏不倚，像早就在那儿等着。旧玉再次发烫，这一次，你没有压住它。";
      if (!state.flags.includes("苏莹低语")) return base;
      return base + "\n\n苏莹不知何时走到你身边，摊开掌心，露出一枚丹丸——蛊息温润，与她平日描符时一样安静。“含着它。”她声音很轻，“你要是死在这儿，我欠的债就没人替我还了。”你将丹丸含入口中，一股暖流顺着经脉化开，连旧玉的灼烫都被压下几分。";
    },
  ...
  fog: {
    ...
    text: "石坪尽头的窄道涌出蛊雾，浓得化不开，灵识被压到不足三尺，连自己的脚尖都看不真切。乔无咎的声音从雾中飘来，说要绕后封住追兵——话音未落，人已没了声息。紧接着，十二具更沉重的傀儡从雾里逼出，脚步碾过碎石，一声比一声近。地面忽然裂开，所有人被陷道吞没。\n\n下坠的混乱里，你只来得及抓住一只手。那只手，属于这一路与你走得最近的人。",
    choices: [
...
const patterns: Record<string, EnemyAction[]> = {
  "铜皮傀儡": [{ id: "pounce", damage: 2, cue: "铜皮傀儡关节一沉，活蛊线绷得咯吱作响，像一头被勒住颈子的猛兽，正在蓄势待扑。" }, { id: "wire", damage: 3, cue: "它眼窝里的蛊核忽明忽暗，数条活蛊线正贴着砖缝向你的脚边游来，像蛇，又像在丈量你站的位置。" }, { id: "crush", damage: 5, cue: "傀儡双臂缓缓抬起，石坪上的碎屑被无形劲力压得贴地滑行，头顶一片阴影沉甸甸地压了下来。" }],
