...
export const scenes: Record<string, Scene> = {
  gate: {
    ...
    choices: [
      { id: "jade", label: "旧玉烫得厉害，你不动声色地把它攥进掌心，只当没察觉", next: "swarm", result: "旧玉在掌心下愈发烫人，仿佛门后有一双眼睛，正透过这枚玉与你遥遥对视。你不动声色地将它攥得更紧，只当什么都没察觉。", effect: { flag: "旧玉发烫" } },
      { id: "observe-su", label: "你落后半步，恰好听清苏莹对着墓门念出的最后几个音节", next: "swarm", result: "你落后半步，恰好听清了苏莹念出的最后几个音节。那声音细若蚊蚋，却在雨声里格外清晰，像是念给门后某位故人听的。", effect: { flag: "苏莹低语" } },
      { id: "enter", label: "你垂下眼，随着乔无咎的背影第一个跨进墓门", next: "swarm", result: "你垂下眼，随着乔无咎的背影跨进墓门。身后的夜雨声，在石门合拢的那一刻，戛然而止。" },
      { id: "insight", label: "你扫过五人散乱的站位，心里忽然浮起一念——这墓门的生门，似不止一个", next: "swarm", result: "你扫过五人散乱的站位，心头忽地一片清明——这墓门的生门，竟不止一个，倒像一张早已布好的棋盘，只等着棋子自己走进去。", requires: { flags: ["高神识"] }, effect: { flag: "识破棋局" } },
    ],
  },
  swarm: {
