...
const patterns: Record<string, EnemyAction[]> = {
  ...
  "血傀儡": [{ id: "lash", damage: 4, cue: "血傀儡胸腔的血核亮起，缠在左腕的锁链随之绷直，贴着池面横抽而来。" }, { id: "smash", damage: 6, cue: "血傀儡右臂缓缓抬起，粗大的拳头压过头顶，正对着你站立之处砸下。" }, { id: "roar", damage: 8, cue: "血傀儡胸腔里的血核连续鼓动，池中血水被牵引到它脚边，正在向外聚成一圈血浪。" }],
  ...
  "乔无咎": [{ id: "wire", damage: 3, essenceDrain: 1, cue: "乔无咎十指扣住牵机丝，细线随即从石梁间交错压下。每收紧一寸，都有一缕真元被牵出蛊窍。" }, { id: "puppets", damage: 6, essenceDrain: 1, cue: "乔无咎拍下阵枢，两侧暗门同时转开。成排铜皮傀儡循着背后绷直的主线向你合围，牵动周围蛊息一并流向控制台。" }, { id: "trap", damage: 9, essenceDrain: 2, cue: "乔无咎猛然压下中央扳杆。你周围的墓砖沿接缝向下陷落，所有牵机丝也朝同一点收束，蛊窍中的真元正被成股扯走。" }],
};
