...
export const illusionEvents: VisualNovelEvent[] = [
  { type: "background", asset: "background.tomb-corridor", transition: "fade" },
  { type: "narration", text: "众人沿暗室后方的石阶向上绕行，重新回到地宫甬道。前行不远，一扇半掩石门出现在火光尽头，门后是一座空旷石殿。\n\n石殿中央立着一方齐腰高的黑色石台。台面刻着数圈细密阵纹，凹槽中凝结着暗红色香膏。火折子的热气刚刚靠近，香膏便散出一缕若有若无的甜味。\n\n你立即闭住呼吸，仍旧迟了一步。甜香附着在殿内残留的真元上，悄然渗入经脉。眼前石殿晃动数下，随即彻底消失。" },
  { type: "narration", text: "你站在一座安静的旧院里。院墙、屋檐与门内的灯火都似曾相识，却无法对应到某段真正的记忆。一个看不清面容的人站在门边，用你许久未曾听过的小名唤你回去。\n\n你明知眼前景象有异，仍不由自主地朝那人走去。就在指尖即将相触时，一声沉喝忽然穿过院墙与灯火，自幻境之外传来。", mode: "center" },
  ...
  { type: "narration", text: "灯火与院墙同时裂开。贴身旧玉随那声沉喝骤然升温，助你从幻境中挣出一线清明。\n\n视野尚未完全恢复，你便看见乔无咎已经站在石台边缘。最先恢复清醒的人正是他。那张泛黄兽皮残图已经被翻到背面，几处原本不起眼的暗红标记与台面阵纹隐隐对应。\n\n乔无咎一边出声唤醒众人，一边依照残图将真元依次打入石台上的几处凹槽。阵纹随之明灭不定，却还没有彻底停止。" },
  { type: "character", action: "show", character: "ji-qinghan", position: "right", expression: "alert" },
  { type: "narration", text: "赵黎、薛逢、苏莹与纪清寒仍被困在各自的幻境中。数缕暗红气息从石台阵纹中升起，分别连向众人的眉心。\n\n纪清寒离你最近。她紧握剑柄，长剑已经出鞘半寸。受紊乱真元牵引，原本对外的剑锋正一点点转向她自己的咽喉。\n\n乔无咎正在尝试最后几处阵纹，尚需片刻才能完全解除迷魂阵。其他人也没有察觉你已经恢复清醒。" },
];
